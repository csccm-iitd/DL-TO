...
class ArgParser(argparse.ArgumentParser):
    def __init__(self):
        super(ArgParser, self).__init__(description='Solving inverse problem using cINN')
        # Block-1
...
#         self.add_argument('--cond_size', type=int, default=128, help='Conditioning dimension')
        self.add_argument('--cond_size', type=int, default=4, help='Conditioning dimension')
        self.add_argument('--hidden_layer_channel', type=int, default=64,
                          help='number of channels for the hidden layer')
        # Block-2
        self.add_argument('--input_dimension1_r', type=list, default=[(2, 32, 32)],
                          help='Input dimension block-2 in CXHXW')
#         self.add_argument('--cond_size1', type=int, default=128, help='Conditioning dimension')
        self.add_argument('--cond_size1', type=int, default=16, help='Conditioning dimension')
        self.add_argument('--hidden_layer_channel1', type=int, default=64,
                          help='number of channels for the hidden layer')
        ...
        # Block-3
        self.add_argument('--input_dimension2_r', type=list, default=[(4, 16, 16)],
                          help='Input dimension block-3 in CXHXW')
#         self.add_argument('--cond_size2', type=int, default=48, help='Conditioning dimension')
        self.add_argument('--cond_size2', type=int, default=32, help='Conditioning dimension')
        self.add_argument('--hidden_layer_channel2', type=int, default=96,
                          help='number of channels for the hidden layer')
        ...
        self.add_argument('--lr', type=float, default=0.00012, help='learnign rate')
        self.add_argument('--weight_decay', type=float, default=0.00003, help="weight decay")
        self.add_argument('--batch-size', type=int, default=16, help='input batch size for training (default: 16)')
        self.add_argument('--test-batch-size', type=int, default=128,
